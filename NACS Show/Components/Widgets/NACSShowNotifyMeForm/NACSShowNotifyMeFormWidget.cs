...
namespace NACSShow.Components.Widgets.NACSShowNotifyMeForm;

public class NACSShowNotifyMeFormWidgetViewComponent : ViewComponent
{
    IInfoProvider<WebsiteCaptchaSettingsInfo> infoProvider;

    public NACSShowNotifyMeFormWidgetViewComponent(IInfoProvider<WebsiteCaptchaSettingsInfo> infoProvider)
    {
    ...
    public IViewComponentResult Invoke(ComponentViewModel<FormWidgetProperties> vm)
    {
        ...
        return View("~/Components/Widgets/NACSShowNotifyMeForm/_NACSShowNotifyMeForm.cshtml", model);
    }
