...
namespace NACSShow.Components.Widgets.NACSShowRegistrationAlertForm;

public class NACSShowRegistrationAlertFormWidgetViewComponent : ViewComponent
{
    IInfoProvider<WebsiteCaptchaSettingsInfo> infoProvider;

    public NACSShowRegistrationAlertFormWidgetViewComponent(IInfoProvider<WebsiteCaptchaSettingsInfo> infoProvider)
    {
    ...
    public IViewComponentResult Invoke(ComponentViewModel<FormWidgetProperties> vm)
    {
        ...
        return View("~/Components/Widgets/NACSShowRegistrationAlertForm/_NACSShowRegistrationAlertForm.cshtml", model);
    }
