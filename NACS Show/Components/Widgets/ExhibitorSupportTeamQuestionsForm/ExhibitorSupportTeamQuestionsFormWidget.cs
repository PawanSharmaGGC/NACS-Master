...
namespace NACSShow.Components.Widgets.ExhibitorSupportTeamQuestionsForm;

public class ExhibitorSupportTeamQuestionsFormWidgetViewComponent : ViewComponent
{
    IInfoProvider<WebsiteCaptchaSettingsInfo> infoProvider;

    public ExhibitorSupportTeamQuestionsFormWidgetViewComponent(IInfoProvider<WebsiteCaptchaSettingsInfo> infoProvider)
    {
    ...
    public IViewComponentResult Invoke(ComponentViewModel<FormWidgetProperties> vm)
    {
        ...
        return View("~/Components/Widgets/ExhibitorSupportTeamQuestionsForm/_ExhibitorSupportTeamQuestionsForm.cshtml", model);
    }
