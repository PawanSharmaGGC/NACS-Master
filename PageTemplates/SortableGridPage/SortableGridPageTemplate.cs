...
[assembly: RegisterPageTemplate("Convenience.PageTemplate.SortableGridPageTemplate",
    "Sortable Grid Page Template",
    customViewName: "~/PageTemplates/SortableGridPage/_SortableGridPage.cshtml",
    Description = "Sortable Grid Page Template")]

namespace Convenience.org.PageTemplates.SortableGridPage
{
    public class SortableGridPageTemplateController : Controller
    {
        ...
        public SortableGridPageTemplateController(IWebPageDataContextRetriever _contextRetriever,
