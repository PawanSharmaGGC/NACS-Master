...
namespace ServiceReference1
{
    ...
    public interface WebServiceSoap
    {
        ...
        ServiceReference1.ArrayOfXElement GetDataSet(string parameter);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/GetDataSet", ReplyAction="*")]
        System.Threading.Tasks.Task<ServiceReference1.ArrayOfXElement> GetDataSetAsync(string parameter);
    }
    ...
    public partial class WebServiceSoapClient : System.ServiceModel.ClientBase<ServiceReference1.WebServiceSoap>, ServiceReference1.WebServiceSoap
    {
        ...
        public ServiceReference1.ArrayOfXElement GetDataSet(string parameter)
        {
            return base.Channel.GetDataSet(parameter);
        }
        
        public System.Threading.Tasks.Task<ServiceReference1.ArrayOfXElement> GetDataSetAsync(string parameter)
        {
            return base.Channel.GetDataSetAsync(parameter);
        }
        ...
        private static System.ServiceModel.EndpointAddress GetEndpointAddress(EndpointConfiguration endpointConfiguration)
        {
            if ((endpointConfiguration == EndpointConfiguration.WebServiceSoap))
            {
                return new System.ServiceModel.EndpointAddress("http://localhost/CMSPages/WebService.asmx");
            }
            if ((endpointConfiguration == EndpointConfiguration.WebServiceSoap12))
            {
                return new System.ServiceModel.EndpointAddress("http://localhost/CMSPages/WebService.asmx");
